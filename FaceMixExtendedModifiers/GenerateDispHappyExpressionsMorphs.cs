...
{
    [Modifier("Generate DispHappy Expressions Morphs")]
    public class GenerateDispHappyExpressionsMorphs : AbstractMorphModifier
    {
        private enum Expression { Happy60 = 0, Happy70 = 1, Happy80 = 2, Happy90 = 3, Happy100 = 4}
        private enum Morph { DispHappy1, DispHappy2, DispHappy3, DispHappy4 }
        ...
        {
            get { return "Generate DispHappy Expressions Morphs"; }
        }
        ...
        public override ListViewItem ToListViewItem(int index)
        {
            ...
            ret.SubItems.Add("Generate DispHappy Expressions Morphs");
